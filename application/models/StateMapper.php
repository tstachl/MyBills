...
class MyBills_Model_StateMapper extends MyBills_Model_Mapper
{
	
	public function __construct()
	{
		parent::__construct('MyBills_Model_DbTable_States');
	}
	
	public function save(MyBills_Model_State $state)
	{
    	Zend_Registry::get('logger')->info(__METHOD__);
    	
		$data = array(
			'country_fk'	=> $state->getCountry()->getIso(),
			'name'			=> $state->getName(),
			'abbrev'		=> $state->getAbbrev()
		);
